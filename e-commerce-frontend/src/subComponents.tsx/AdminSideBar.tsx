...
function AdminSideBar({setPage,page}:forSideBarProp) {
  ...
  return (
    ...
    <div className="flex flex-col items-center  ">
      <div className="text-4xl font-semibold color">ShopCart</div>
    </div>
    <div className="flex flex-col gap-6 w-full text-center">
        <ul className="flex flex-col gap-2 ">
          ...
          <li className={`pl-10 ${page==="categories"&& "bg-blue-200"} cursor-pointer`}  onClick={()=>{setPage("categories")}}>categorylist</li>
        </ul>
